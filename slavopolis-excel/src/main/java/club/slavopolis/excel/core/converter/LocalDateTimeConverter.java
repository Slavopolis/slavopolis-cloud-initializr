package club.slavopolis.excel.core.converter;
...
public class LocalDateTimeConverter implements ExcelDataConverter<LocalDateTime> {
    ...
    private static final DateTimeFormatter DEFAULT_FORMATTER = DateTimeFormatter.ofPattern(DateConstants.DATETIME_PATTERN);
    ...
    private LocalDateTime parseWithMultipleFormats(String value) {
        for (String pattern : DateConstants.getCommonDateTimePatterns()) {
            try {
                ...
                if (pattern.contains("HH")) {
                    ...
                    return LocalDateTime.parse(value + DateConstants.DEFAULT_TIME_SUFFIX, 
                        DateTimeFormatter.ofPattern(pattern + DateConstants.DEFAULT_TIME_SUFFIX.trim()));
                }
