...
public @interface ExcelField {
     ...
     * 默认值
     */
    String defaultValue() default CommonConstants.EMPTY;
     ...
     * 日期格式（针对日期类型）
     */
    String dateFormat() default DateTimeUtil.DATETIME_PATTERN;

    /**
     * 数字格式（针对数字类型）
     */
    String numberFormat() default CommonConstants.EMPTY;
     ...
     * 正则表达式验证
     */
    String pattern() default CommonConstants.EMPTY;

    /**
     * 验证错误消息
     */
    String message() default CommonConstants.EMPTY;
     ...
     * 单元格样式
     */
    String cellStyle() default CommonConstants.EMPTY;
