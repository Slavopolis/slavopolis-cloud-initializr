package club.slavopolis.infrastructure.messaging.email.service.impl;
...
import club.slavopolis.infrastructure.messaging.email.enums.ContentType;
import club.slavopolis.infrastructure.messaging.email.enums.EmailErrorCode;
import club.slavopolis.infrastructure.messaging.email.enums.Priority;
import club.slavopolis.infrastructure.messaging.email.enums.SendStatus;
import club.slavopolis.infrastructure.messaging.email.exception.EmailSendException;
import club.slavopolis.infrastructure.messaging.email.exception.EmailTemplateException;
import club.slavopolis.infrastructure.messaging.email.model.EmailAttachment;
import club.slavopolis.infrastructure.messaging.email.model.EmailInlineResource;
