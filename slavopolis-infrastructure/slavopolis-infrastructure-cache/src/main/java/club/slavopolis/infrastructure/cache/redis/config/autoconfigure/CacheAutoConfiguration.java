package club.slavopolis.infrastructure.cache.redis.config.autoconfigure;

import club.slavopolis.infrastructure.cache.redis.config.RedisAutoConfiguration;
...
import club.slavopolis.infrastructure.cache.redis.service.impl.CacheServiceImpl;
