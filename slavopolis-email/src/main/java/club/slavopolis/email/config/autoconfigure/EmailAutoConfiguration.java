...
import club.slavopolis.email.config.EmailWebConfiguration;
import club.slavopolis.email.config.properties.EmailProperties;
import club.slavopolis.email.service.EmailService;
import club.slavopolis.email.service.impl.EmailServiceImpl;
import club.slavopolis.email.template.EmailTemplateEngine;
import club.slavopolis.email.template.impl.FreemarkerEmailTemplateEngine;
import club.slavopolis.email.template.impl.ThymeleafEmailTemplateEngine;
