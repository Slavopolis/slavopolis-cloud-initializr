 ...
 * All rights reserved.
 */
public class HttpFileProcessingException extends HttpClientException {
     ...
     */
    public HttpFileProcessingException(String message, Throwable cause, ErrorCode errorCode, 
